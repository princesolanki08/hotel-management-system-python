...
class Hotel_Management_System:
    def __init__(self,root):
      ...
      # label ki Image
      img1=Image.open(r"D:\My Projects\Hotel Management Project\Images\img1.jpg")
      ...
      # Right Side Image
      img3=Image.open(r"D:\My Projects\Hotel Management Project\Images\img3.jpg")
      ...
      # Buttons ke niche ki image 1
      img4=Image.open(r"D:\My Projects\Hotel Management Project\Images\img4.jpg")
      img4=img4.resize((230,210))
      self.photoimg4=ImageTk.PhotoImage(img4)

      lblimg1=Label(main_frame,image=self.photoimg4,bd=4,relief=RIDGE)
      lblimg1.place(x=0,y=150,width=229,height=200)

     # Buttons ke niche ki image 2
      img5=Image.open(r"D:\My Projects\Hotel Management Project\Images\img5.jpg")
      img5=img5.resize((230,190))
      self.photoimg5=ImageTk.PhotoImage(img5)

      lblimg1=Label(main_frame,image=self.photoimg5,bd=4,relief=RIDGE)
      lblimg1.place(x=0,y=350,width=229,height=190)
